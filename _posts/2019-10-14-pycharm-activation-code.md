---
layout:       post
title:        "PyCharm activation code"
subtitle:     “Jet Brains 全家桶通用，永久授权，好用到哭泣”
...
Jet brains 全家桶永久授权激活码， 可用于激活pycharm，真的好用啊。
...
```
***
激活码虽好用，但使用前还是要修改host文件，屏蔽掉pycharm对激活码的验证。
